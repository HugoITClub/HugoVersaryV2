...
import { GAPI_KEY, GAPI_LIBRARY, SHEET_DISCOVERY_DOC } from "./constants";
  ...
  const handleGApiScriptTagLoaded = () => {
    ...
    async function start() {
      ...
      await gApi.client.init({
        // Required API key
        apiKey: GAPI_KEY,
        // API key will be automatically added to the Discovery Document URLs.
        discoveryDocs: [SHEET_DISCOVERY_DOC],
      });
