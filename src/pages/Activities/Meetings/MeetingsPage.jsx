...
export default function MeetingsPage() {
  const { isLoading, isFull, data: meetings, getMore: getMoreMeeting } = useSheetAPI("Meeting", "K", "P", { earlyTake: 8 });
          ...
          {!isFull && (
            <div className="row justify-content-center mt-5">
              <div className="col-auto">
                <button className={joinCls("btn btn-lg btn-outline-gradient rounded-pill", style["see-more-btn"])} onClick={() => getMoreMeeting(8)}>
                  SEE MORE
                </button>
              </div>
            </div>
