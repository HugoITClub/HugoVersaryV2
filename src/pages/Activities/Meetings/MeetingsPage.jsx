      ...
      <div className="team-meeting">
        ...
        <div id="team-meeting" className="container justify-content-around">
          <div className="row">
            <a
              href="#"
              className={joinCls("col-5 text-decoration-none", style["post"])}
            >
              <div className="row justify-content-around">
                ...
                <div className="col-6">
                  ...
                  >
                    ...
                    Nunc vulputate libero,Nunc vulputate libero Nunc vulputate
                    libero,Nunc vulputate libero Nunc vulputate libero,Nunc
                    vulputate libero
                  </div>
                  <div
                    className={joinCls(
