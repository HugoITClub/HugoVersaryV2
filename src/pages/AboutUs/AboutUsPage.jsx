		...
		<div>
			...
			<div className={joinCls("container position-relative", style["about-us-wrap"])}>
				...
				<div className="row position-relative">
					...
					<div className={joinCls("col-10 text-start", style["about-us-content"])}>
				...
				<Slider
					...
					renderItem={([id, imageUrl]) => (
						<div key={id} className={style["about-us-item"]}>
							<Image src={imageUrl} className={style["card-img"]} />
						</div>
					)}
				/>
				<div className="mt-10 row">
					<div className="col-12">
						<div className={style["club-name"]}>Hugo English Club</div>
				...
				<div className="mt-10 row position-relative">
					<Wiggle className={joinCls("position-absolute", style["rect-decor-2-3"])}>
						<Image src={RectDecor2Svg} />
					</Wiggle>
					<div className="col-12">
						<div className={style["club-name"]}>Active Time</div>
						<div className={joinCls("mt-5", style["club-description"])}>
							•<span className="ms-3 fw-bold">Meeting time:</span> 8:00 A.M., every Sunday.
							<br /> •<span className="ms-3 fw-bold">Meeting venue:</span> Block C’s Yard, in front of room C116, The University of Science and Technology.
							<br /> •
							<span className="ms-3">
							...
							<span className="ms-2 fw-bold">check your email inbox and group notifications</span> before every meeting.
							<br /> • <span className="ms-3 fw-bold">How to receive notifications:</span>
				...
				<div className="mt-10 row position-relative">
					...
					<div className="col-12">
						<div className={style["club-name"]}>Club's Activities</div>
						<div className={joinCls("mt-5", style["club-description"])}>
							<div className="row justify-content-around">
								<div className="col-3 fw-bold text-start">Weekly Meeting</div>
								<div className="col-9">
							...
							<div className="row justify-content-around mt-5">
								<div className="col-3 fw-bold text-start">Team Meeting</div>
								<div className="col-9">
							...
							<div className="row justify-content-around mt-5">
								<div className="col-3 fw-bold text-start">Team Building Event</div>
								<div className="col-9">Extracurricular activities will be hosted at public spaces in order to practice common use English and members’ teamwork skills.</div>
							</div>
							<div className="row justify-content-around mt-5">
								<div className="col-3 fw-bold text-start">Collaboration</div>
								<div className="col-9">Conjoining with other clubs in Danang City.</div>
							</div>
							<div className="row justify-content-around mt-5">
								<div className="col-3 fw-bold text-start">English Contest</div>
								<div className="col-9">
							...
							<div className="row justify-content-around mt-5">
								<div className="col-3 fw-bold text-start">Camping</div>
								<div className="col-9">Members can participate in Team Camps and Club Camps. Whereas Hugo Camp will be the biggest event annually.</div>
							</div>
							<div className="row justify-content-around mt-5">
								<div className="col-3 fw-bold text-start">Cultural Exchange</div>
								<div className="col-9">Participating in cultural programs with foreigners.</div>
							</div>
							<div className="row justify-content-around mt-5">
								<div className="col-3 fw-bold text-start">Soft-Skill Contest</div>
								<div className="col-9">This will usually be a collaboration with other clubs, with the aim to enhance soft skills as well as practice in-use English.</div>
							</div>
							<div className="row justify-content-around mt-5">
								<div className="col-3 fw-bold text-start">Boardgame</div>
								<div className="col-9">Recreational activities,...</div>
							</div>
							<div className="row justify-content-around mt-5">
								<div className="col-3 fw-bold text-start">Group</div>
								<div className="col-9">Movements organized in the official group of Hugo English Club.</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div className="position-relative container mt-10 z-1">
				...
				<div className={joinCls("text-start row justify-content-center position-relative", style["about-human-description"])}>
					...
					<div className={style["club-name"]}>Hugo Staff 2022 - 2023</div>
					<div className={joinCls("mt-5", style["club-description"])}>
