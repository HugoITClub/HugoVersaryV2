    ...
    <div className="bg-black">
      ...
      <section className={joinCls("container", style["explore"])}>
        ...
        <p className="text-light text-center fst-italic fs-5 mt-5">
          "Each Power Rangers's member has an unique color and that creates an
          unique team. But we are always willing to support and assist all
          others to overcome all difficulties, strive to conquer themselves and
          create meaningful values for society. The special thing about the PRs
          team is that we always respect, sympathize and share together to
          create a sense of solidarity so that everyone is always happy and
